...
clear *all X Y Z i A
x_map=mypcg(AtA,A_f'*b1_x,1e-10,5000,M);
y_map=mypcg(AtA,A_f'*b1_y,1e-10,5000,M);

if (Pp ~= 2)
    x_map=mypcgdlp(A_f,b1_x,x_map,1e-12,1000,Pp);%<----
    y_map=mypcgdlp(A_f,b1_y,y_map,1e-12,1000,Pp);%<----
end
